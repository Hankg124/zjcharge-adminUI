...
export default {
  ...
  accAdd(num1, num2) {
    ...
    gtimes = Math.pow(10, Math.max(dec1, dec2));
    const result = (this.accMul(num1, gtimes) + this.accMul(num2, gtimes)) / gtimes;
  ...
  accSub(num1, num2) {
    ...
    gtimes = Math.pow(10, Math.max(dec1, dec2));
    const result = Number((this.accMul(num1, gtimes) - this.accMul(num2, gtimes)) / gtimes);

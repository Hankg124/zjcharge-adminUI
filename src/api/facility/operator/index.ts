...
export function listOperator(query) {
  return request({
    url: '/usercharge/zj/v1/operator/page',
    method: 'get',
    params: query
  });
}
...
export function getOperator(operatorId) {
  return request({
    url: '/usercharge/zj/v1/operator/' + praseStrEmpty(operatorId),
    method: 'get'
  });
}
...
export function delOperator(operatorId) {
  return request({
    url: '/usercharge/zj/v1/operator/' + operatorId,
    method: 'delete'
  });
}

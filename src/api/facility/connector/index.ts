...
export function listConnector(query) {
  return request({
    url: '/usercharge/zj/v1/connector/list',
    method: 'get',
    params: query
  });
}
...
export function getConnector(connectorId) {
  return request({
    url: '/usercharge/zj/v1/connector/' + praseStrEmpty(connectorId),
    method: 'get'
  });
}
...
export function addConnector(data) {
  return request({
    url: '/usercharge/zj/v1/connector',
    method: 'post',
    data: data
  });
}
...
export function delConnector(connectorId) {
  return request({
    url: '/usercharge/zj/v1/connector/' + connectorId,
    method: 'delete'
  });
}

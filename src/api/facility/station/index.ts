...
export function listStation(query) {
  return request({
    url: '/usercharge/zj/v1/station/page',
    method: 'get',
    params: query
  });
}
...
export function listSimpleStation(query) {
  return request({
    url: '/usercharge/zj/v1/station/simplelist',
    method: 'get',
    params: query
  });
}
...
export function getArealist() {
  return request({
    url: '/usercharge/zj/v1/menu/arealist',
    method: 'get'
  });
}
...
export function treeStation(query) {
  return request({
    url: '/basecharge/hlht/v1/sys/station/tree',
    method: 'get',
    params: query
  });
}
...
export function getStation(stationId) {
  return request({
    url: '/usercharge/zj/v1/station/' + praseStrEmpty(stationId),
    method: 'get'
  });
}
...
export function getStationPrice(stationId) {
  return request({
    url: '/usercharge/zj/v1/station/price/' + stationId,
    method: 'get'
  });
}
...
export function addStationExtend(data) {
  return request({
    url: '/usercharge/zj/v1/station/local',
    method: 'post',
    data: data
  });
}
...
export function listParkingPeriod(query) {
  return request({
    url: '/usercharge/zj/v1/station/park/list',
    method: 'get',
    params: query
  });
}
...
export function getParkingPeriod(periodId) {
  return request({
    url: '/usercharge/zj/v1/station/park/' + praseStrEmpty(periodId),
    method: 'get'
  });
}
...
export function addParkingPeriod(data) {
  return request({
    url: '/usercharge/zj/v1/station/park',
    method: 'post',
    data: data
  });
}
...
export function listPrice(query) {
  return request({
    url: '/usercharge/zj/v1/price/list',
    method: 'get',
    params: query
  });
}
...
export function getPrice(priceId) {
  return request({
    url: '/usercharge/zj/v1/price/' + praseStrEmpty(priceId),
    method: 'get'
  });
}
...
export function addPriceArr(data) {
  return request({
    url: '/usercharge/zj/v1/price/mulAdd',
    method: 'post',
    data: data
  });
}
...
export function listPricePeriod(query) {
  return request({
    url: '/usercharge/zj/v1/price/relate/list',
    method: 'get',
    params: query
  });
}
...
export function getPricePeriod(relateId) {
  return request({
    url: '/usercharge/zj/v1/price/relate/' + praseStrEmpty(relateId),
    method: 'get'
  });
}
...
export function addPricePeriod(data) {
  return request({
    url: '/usercharge/zj/v1/price/relate',
    method: 'post',
    data: data
  });
}
...
export function updatePriceAndPeriod(data) {
  return request({
    url: '/usercharge/zj/v1/price/priceOption',
    method: 'post',
    data: data
  });
}
...
export function addPricePeriodArr(data) {
  return request({
    url: '/usercharge/zj/v1/price/relate/mulAdd',
    method: 'post',
    data: data
  });
}
...
export function listDiscountPeriod(query) {
  return request({
    url: '/usercharge/zj/v1/price/preferential/list',
    method: 'get',
    params: query
  });
}
...
export function getDiscountPeriod(id) {
  return request({
    url: '/usercharge/zj/v1/price/preferential/' + praseStrEmpty(id),
    method: 'get'
  });
}
...
export function addDiscountPeriod(data) {
  return request({
    url: '/usercharge/zj/v1/price/preferential',
    method: 'post',
    data: data
  });
}
...
export function addDiscountPeriodArr(data) {
  return request({
    url: '/usercharge/zj/v1/price/preferential/batchAdd',
    method: 'post',
    data: data
  });
}
...
export function updateAlarmCfg(data) {
  return request({
    url: '/usercharge/zj/v1/station/alarmCfg',
    method: 'post',
    data: data
  });
}
...
export function getAlarmCfg(id) {
  return request({
    url: '/usercharge/zj/v1/station/alarmCfg/' + praseStrEmpty(id),
    method: 'get'
  });
}

...
const envAppname = ref(import.meta.env.VITE_APP_TITLE);
const envHotline = ref(import.meta.env.VITE_APP_HOTLINE);
const envCopyright = ref(import.meta.env.VITE_APP_COPYRIGHT);
const envKeyword = ref(import.meta.env.VITE_APP_KEYWORD);

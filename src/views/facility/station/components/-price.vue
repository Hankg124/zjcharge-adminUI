<template>
  <div>
    ...
    <el-button type="primary" style="width: 120px" @click="doSave()">保存</el-button>
  </div>
</template>

<script>
import { getStationPrice, getPriceTemplate, linkStations } from '@/api/basecharge/priceTemplate';
